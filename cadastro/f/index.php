      ...
      <form action="../../conta/php/functions/registrarfreelancer.php" autocomplete="off" method="POST">
        ...
        <div class="row" style="margin-top:90px">
          ...
          <div class="col m12 s12">
            ...
            <div class="input-field col m6 s12">
              <i class="material-icons prefix">lock</i>
              <input pattern="[a-z A-Z @ 1-9]+" id="icon_telephone" type="password" required name="novasenha" class="validate">
              <label for="icon_telephone" data-error="insira uma senha valida" data-success="perfeito">Repita sua senha</label>
            </div>
            ...
            <div class="input-field col m6 s12">
              ...
              <input type="date" class="datepicker" name="datanascimento" id="datepicker">
