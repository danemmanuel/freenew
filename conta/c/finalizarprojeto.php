    ...
    <div class="content-wrapper">
      <section class="content">
       <section class="pricing-section bg-8">
        ...
        ?>
        <form method="POST" action="../php/functions/avaliar.php">
          <input type="hidden" value="<?php echo $idmensagem ?>" name="idmensagem">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="input-group" style="width:100%;"><br>
                <button type="submit" class="btn btn-block btn-success btn-lg">Enviar Avaliação</button>
              </div>
            </div>
          </div>
